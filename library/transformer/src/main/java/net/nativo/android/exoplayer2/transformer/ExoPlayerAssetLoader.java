...
import static net.nativo.android.exoplayer2.DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_AFTER_REBUFFER_MS;
import static net.nativo.android.exoplayer2.DefaultLoadControl.DEFAULT_BUFFER_FOR_PLAYBACK_MS;
import static net.nativo.android.exoplayer2.DefaultLoadControl.DEFAULT_MAX_BUFFER_MS;
import static net.nativo.android.exoplayer2.DefaultLoadControl.DEFAULT_MIN_BUFFER_MS;
...
import net.nativo.android.exoplayer2.DefaultLoadControl;
...
/* package */ final class ExoPlayerAssetLoader {
  ...
  public ExoPlayerAssetLoader(
    ...
    this.clock = clock;
    progressState = Transformer.PROGRESS_STATE_NO_TRANSFORMATION;
  }
  ...
  private final class PlayerListener implements Player.Listener {
    ...
    public void onTimelineChanged(Timeline timeline, int reason) {
      if (progressState != Transformer.PROGRESS_STATE_WAITING_FOR_AVAILABILITY) {
        return;
      }
