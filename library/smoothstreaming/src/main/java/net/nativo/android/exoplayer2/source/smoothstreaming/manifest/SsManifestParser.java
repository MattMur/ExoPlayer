 ...
 */
package net.nativo.android.exoplayer2.source.smoothstreaming.manifest;
...
public class SsManifestParser implements ParsingLoadable.Parser<SsManifest> {
  ...
  private static class SmoothStreamingMediaParser extends ElementParser {
    ...
    @Nullable private SsManifest.ProtectionElement protectionElement;
    ...
    public void addChild(Object child) {
      if (child instanceof SsManifest.StreamElement) {
        streamElements.add((SsManifest.StreamElement) child);
      } else if (child instanceof SsManifest.ProtectionElement) {
        Assertions.checkState(protectionElement == null);
        protectionElement = (SsManifest.ProtectionElement) child;
      }
    }

    @Override
    public Object build() {
      SsManifest.StreamElement[] streamElementArray = new SsManifest.StreamElement[streamElements.size()];
  ...
  private static class ProtectionParser extends ElementParser {
    ...
    @Override
    public Object build() {
      return new SsManifest.ProtectionElement(
  ...
  private static class StreamIndexParser extends ElementParser {
    ...
    public Object build() {
      ...
      return new SsManifest.StreamElement(
          baseUri,
          url,
          type,
          subType,
