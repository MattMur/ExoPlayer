...
import static net.nativo.android.exoplayer2.Player.EVENT_AVAILABLE_COMMANDS_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_IS_PLAYING_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_PLAYBACK_PARAMETERS_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_PLAYBACK_STATE_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_PLAY_WHEN_READY_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_POSITION_DISCONTINUITY;
import static net.nativo.android.exoplayer2.Player.EVENT_REPEAT_MODE_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_SEEK_BACK_INCREMENT_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_SEEK_FORWARD_INCREMENT_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_SHUFFLE_MODE_ENABLED_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_TIMELINE_CHANGED;
import static net.nativo.android.exoplayer2.Player.EVENT_TRACKS_CHANGED;
...
import net.nativo.android.exoplayer2.Player.Events;
import net.nativo.android.exoplayer2.Player.State;
