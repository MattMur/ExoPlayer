...
public class HlsDownloaderTest {
  ...
  public void setUp() throws Exception {
    ...
    fakeDataSet =
        new FakeDataSet()
            .setData(HlsDownloadTestData.MULTIVARIANT_PLAYLIST_URI, HlsDownloadTestData.MULTIVARIANT_PLAYLIST_DATA)
            .setData(HlsDownloadTestData.MEDIA_PLAYLIST_1_URI, HlsDownloadTestData.MEDIA_PLAYLIST_DATA)
            ...
            .setData(HlsDownloadTestData.MEDIA_PLAYLIST_2_URI, HlsDownloadTestData.MEDIA_PLAYLIST_DATA)
  ...
  public void counterMethods() throws Exception {
    HlsDownloader downloader =
        getHlsDownloader(HlsDownloadTestData.MULTIVARIANT_PLAYLIST_URI, getKeys(HlsDownloadTestData.MULTIVARIANT_MEDIA_PLAYLIST_1_INDEX));
    downloader.download(progressListener);

    progressListener.assertBytesDownloaded(HlsDownloadTestData.MEDIA_PLAYLIST_DATA.length + 10 + 11 + 12);
  }
  ...
  public void downloadMultipleRepresentations() throws Exception {
    HlsDownloader downloader =
        getHlsDownloader(
            HlsDownloadTestData.MULTIVARIANT_PLAYLIST_URI,
            getKeys(HlsDownloadTestData.MULTIVARIANT_MEDIA_PLAYLIST_1_INDEX, HlsDownloadTestData.MULTIVARIANT_MEDIA_PLAYLIST_2_INDEX));
    downloader.download(progressListener);
  ...
  public void downloadEncMediaPlaylist() throws Exception {
    fakeDataSet =
        new FakeDataSet()
            .setData(HlsDownloadTestData.ENC_MEDIA_PLAYLIST_URI, HlsDownloadTestData.ENC_MEDIA_PLAYLIST_DATA)
