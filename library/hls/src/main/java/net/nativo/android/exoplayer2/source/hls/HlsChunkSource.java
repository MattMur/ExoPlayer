...
import net.nativo.android.exoplayer2.source.chunk.DataChunk;
...
/* package */ class HlsChunkSource {
  ...
  public @ChunkPublicationState int getChunkPublicationState(HlsMediaChunk mediaChunk) {
    ...
    HlsMediaPlaylist mediaPlaylist =
        Assertions.checkNotNull(playlistTracker.getPlaylistSnapshot(playlistUrl, /* isForPlayback= */ false));
  ...
  public void onChunkLoadCompleted(Chunk chunk) {
    if (chunk instanceof EncryptionKeyChunk) {
      ...
      keyCache.put(encryptionKeyChunk.dataSpec.uri, Assertions.checkNotNull(encryptionKeyChunk.getResult()));
    }
  }
