...
import net.nativo.android.exoplayer2.source.hls.playlist.DefaultHlsPlaylistParserFactory;
import net.nativo.android.exoplayer2.source.hls.playlist.DefaultHlsPlaylistTracker;
import net.nativo.android.exoplayer2.source.hls.playlist.FilteringHlsPlaylistParserFactory;
import net.nativo.android.exoplayer2.source.hls.playlist.HlsMediaPlaylist;
import net.nativo.android.exoplayer2.source.hls.playlist.HlsPlaylistParserFactory;
...
public final class HlsMediaSource extends BaseMediaSource
  ...
  private HlsMediaSource(
    ...
    this.localConfiguration = Assertions.checkNotNull(mediaItem.localConfiguration);
  ...
  protected void prepareSourceInternal(@Nullable TransferListener mediaTransferListener) {
    ...
    drmSessionManager.setPlayer(
        /* playbackLooper= */ Assertions.checkNotNull(Looper.myLooper()), getPlayerId());
  ...
  public void onPrimaryPlaylistRefreshed(HlsMediaPlaylist mediaPlaylist) {
    ...
    HlsManifest manifest =
        new HlsManifest(Assertions.checkNotNull(playlistTracker.getMultivariantPlaylist()), mediaPlaylist);
