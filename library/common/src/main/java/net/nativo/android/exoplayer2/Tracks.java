...
public final class Tracks implements Bundleable {
  ...
  public static final class Group implements Bundleable {
    ...
    public Group(
      ...
      Assertions.checkArgument(length == trackSupport.length && length == trackSelected.length);
    ...
    public static final Creator<Group> CREATOR =
        bundle -> {
          ...
          TrackGroup trackGroup =
              TrackGroup.CREATOR.fromBundle(Assertions.checkNotNull(bundle.getBundle(FIELD_TRACK_GROUP)));
  ...
  public Bundle toBundle() {
    Bundle bundle = new Bundle();
    bundle.putParcelableArrayList(FIELD_TRACK_GROUPS, BundleableUtil.toBundleArrayList(groups));
    return bundle;
  }
