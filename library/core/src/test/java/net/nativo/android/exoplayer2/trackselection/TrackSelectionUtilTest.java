...
import static net.nativo.android.exoplayer2.C.FORMAT_UNSUPPORTED_DRM;
...
import static net.nativo.android.exoplayer2.C.TRACK_TYPE_AUDIO;
import static net.nativo.android.exoplayer2.C.TRACK_TYPE_UNKNOWN;
import static net.nativo.android.exoplayer2.C.TRACK_TYPE_VIDEO;
import static net.nativo.android.exoplayer2.RendererCapabilities.ADAPTIVE_NOT_SUPPORTED;
import static net.nativo.android.exoplayer2.RendererCapabilities.ADAPTIVE_SEAMLESS;
import static net.nativo.android.exoplayer2.util.MimeTypes.AUDIO_AAC;
import static net.nativo.android.exoplayer2.util.MimeTypes.AUDIO_OPUS;
