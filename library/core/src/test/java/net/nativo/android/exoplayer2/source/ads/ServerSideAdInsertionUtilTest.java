...
import static net.nativo.android.exoplayer2.source.ads.ServerSideAdInsertionUtil.getStreamPositionUsForAd;
import static net.nativo.android.exoplayer2.source.ads.ServerSideAdInsertionUtil.getStreamPositionUsForContent;
...
public final class ServerSideAdInsertionUtilTest {
  ...
  public void addAdGroupToAdPlaybackState_emptyLeadingAds_markedAsSkipped() {
    ...
    assertThat(Arrays.stream(adGroup.durationsUs).sum()).isEqualTo(50_000);
  }
