...
import net.nativo.android.exoplayer2.audio.AudioRendererEventListener.EventDispatcher;
import net.nativo.android.exoplayer2.audio.AudioSink.InitializationException;
import net.nativo.android.exoplayer2.audio.AudioSink.WriteException;
...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
  ...
  protected DecoderReuseEvaluation canReuseCodec(
    ...
    @DecoderReuseEvaluation.DecoderDiscardReasons int discardReasons = evaluation.discardReasons;
  ...
  protected int getCodecMaxInputSize(
    ...
    for (Format streamFormat : streamFormats) {
      if (codecInfo.canReuseCodec(format, streamFormat).result != DecoderReuseEvaluation.REUSE_RESULT_NO) {
