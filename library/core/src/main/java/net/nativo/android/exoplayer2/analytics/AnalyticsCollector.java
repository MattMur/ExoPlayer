...
import net.nativo.android.exoplayer2.Player.PlaybackSuppressionReason;
...
public class AnalyticsCollector
  ...
  public final void onPlayerError(PlaybackException error) {
    @Nullable AnalyticsListener.EventTime eventTime = null;
    ...
    AnalyticsListener.EventTime finalEventTime = eventTime;
    sendEvent(
        eventTime,
  ...
  private AnalyticsListener.EventTime generateEventTime(@Nullable MediaPeriodId mediaPeriodId) {
    checkNotNull(player);
    @Nullable
