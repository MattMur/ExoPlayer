...
public abstract class DownloadService extends Service {
  ...
  public static Intent buildAddDownloadIntent(
      ...
      boolean foreground) {
    return buildAddDownloadIntent(context, clazz, downloadRequest, Download.STOP_REASON_NONE, foreground);
  }
  ...
  private final class ForegroundNotificationUpdater {
    ...
    private void update() {
      ...
      @Requirements.RequirementFlags int notMetRequirements = downloadManager.getNotMetRequirements();
