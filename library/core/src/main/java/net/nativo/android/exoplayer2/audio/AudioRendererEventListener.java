...
public interface AudioRendererEventListener {
  ...
  final class EventDispatcher {
    ...
    public void enabled(DecoderCounters decoderCounters) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onAudioEnabled(decoderCounters));
      }
    }
    ...
    public void inputFormatChanged(
      ...
      if (handler != null) {
        handler.post(
            () -> {
              Util.castNonNull(listener).onAudioInputFormatChanged(format);
              Util.castNonNull(listener).onAudioInputFormatChanged(format, decoderReuseEvaluation);
            });
      }
    }
    ...
    public void positionAdvancing(long playoutStartSystemTimeMs) {
      if (handler != null) {
        handler.post(
            () -> Util.castNonNull(listener).onAudioPositionAdvancing(playoutStartSystemTimeMs));
      }
    }
    ...
    public void decoderReleased(String decoderName) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onAudioDecoderReleased(decoderName));
      }
    }
    ...
    public void disabled(DecoderCounters counters) {
      ...
      if (handler != null) {
        handler.post(
            () -> {
              counters.ensureUpdated();
              Util.castNonNull(listener).onAudioDisabled(counters);
            });
      }
    }
    ...
    public void skipSilenceEnabledChanged(boolean skipSilenceEnabled) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onSkipSilenceEnabledChanged(skipSilenceEnabled));
      }
    }
    ...
    public void audioSinkError(Exception audioSinkError) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onAudioSinkError(audioSinkError));
      }
    }
    ...
    public void audioCodecError(Exception audioCodecError) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onAudioCodecError(audioCodecError));
      }
    }
  }
}
