...
import static net.nativo.android.exoplayer2.C.usToMs;
...
public final class DefaultPlaybackSessionManager implements PlaybackSessionManager {
  ...
  public synchronized void updateSessions(AnalyticsListener.EventTime eventTime) {
    ...
    if (eventTime.mediaPeriodId != null && eventTime.mediaPeriodId.isAd()) {
      ...
      if (!contentSession.isCreated) {
        ...
        AnalyticsListener.EventTime eventTimeForContent =
  ...
  public synchronized void updateSessionsWithDiscontinuity(
      AnalyticsListener.EventTime eventTime, @DiscontinuityReason int reason) {
    Assertions.checkNotNull(listener);
