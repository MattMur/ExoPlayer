...
import static net.nativo.android.exoplayer2.util.Assertions.checkNotEmpty;
...
public final class DecoderReuseEvaluation {
  ...
  public DecoderReuseEvaluation(
    ...
    Assertions.checkArgument(result == REUSE_RESULT_NO || discardReasons == 0);
    this.decoderName = Assertions.checkNotEmpty(decoderName);
    this.oldFormat = Assertions.checkNotNull(oldFormat);
    this.newFormat = Assertions.checkNotNull(newFormat);
    this.result = result;
