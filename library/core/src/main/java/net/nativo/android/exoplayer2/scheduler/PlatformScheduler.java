 ...
 */
package net.nativo.android.exoplayer2.scheduler;
 ...
 *
 * <service android:name="net.nativo.android.exoplayer2.scheduler.PlatformScheduler$PlatformSchedulerService"
...
public final class PlatformScheduler implements Scheduler {
  ...
  public PlatformScheduler(Context context, int jobId) {
    ...
    jobScheduler =
        Assertions.checkNotNull((JobScheduler) context.getSystemService(Context.JOB_SCHEDULER_SERVICE));
  }
