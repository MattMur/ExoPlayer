...
/**
 * Defines and provides media to be played by an {@link ExoPlayer}. A
 ...
 * ExoPlayer} Javadoc. They should not be called directly from
 * application code. Instances can be re-used, but only for one {@link
 * ExoPlayer} instance simultaneously.
 */
public interface MediaSource {
  ...
  final class MediaPeriodId extends net.nativo.android.exoplayer2.source.MediaPeriodId {
    ...
    /**
     * See {@link net.nativo.android.exoplayer2.source.MediaPeriodId#MediaPeriodId(Object, long)}.
     */
    ...
    /**
     * See {@link net.nativo.android.exoplayer2.source.MediaPeriodId#MediaPeriodId(Object, int, int,
     * long)}.
     */
    ...
    /** See {@link net.nativo.android.exoplayer2.source.MediaPeriodId#copyWithPeriodUid(Object)}. */
    @Override
    ...
    /**
     * See {@link
     * net.nativo.android.exoplayer2.source.MediaPeriodId#copyWithWindowSequenceNumber(long)}.
     */
    @Override
