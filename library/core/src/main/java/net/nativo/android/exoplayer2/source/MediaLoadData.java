...
public final class MediaLoadData {
  ...
  /** The {@link C.DataType data type}. */
  public final @C.DataType int dataType;
  /**
   * One of the {@link C.TrackType track types}, which is a media track type if the data corresponds
  ...
  /**
   * One of the {@link C.SelectionReason selection reasons} if the data belongs to a track. {@link
