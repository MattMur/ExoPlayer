...
/* package */ class SampleDataQueue {
  ...
  private static AllocationNode readSampleData(
      ...
      SampleQueue.SampleExtrasHolder extrasHolder,
   ...
   * SampleQueue.SampleExtrasHolder#size} is adjusted to subtract the number of bytes that were read. The same
   * value is added to {@link SampleQueue.SampleExtrasHolder#offset}.
   *
   * @param allocationNode The first {@link AllocationNode} containing data yet to be read.
