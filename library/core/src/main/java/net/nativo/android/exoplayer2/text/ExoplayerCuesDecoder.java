...
public final class ExoplayerCuesDecoder implements SubtitleDecoder {
  ...
  public void queueInputBuffer(SubtitleInputBuffer inputBuffer) throws SubtitleDecoderException {
    Assertions.checkState(!released);
    Assertions.checkState(inputBufferState == INPUT_BUFFER_DEQUEUED);
    Assertions.checkArgument(this.inputBuffer == inputBuffer);
    ...
    if (inputBuffer.isEndOfStream()) {
      ...
      SingleEventSubtitle subtitle =
          new SingleEventSubtitle(
              inputBuffer.timeUs, cueDecoder.decode(Assertions.checkNotNull(inputBuffer.data).array()));
  ...
  private void releaseOutputBuffer(SubtitleOutputBuffer outputBuffer) {
    Assertions.checkState(availableOutputBuffers.size() < OUTPUT_BUFFERS_COUNT);
    Assertions.checkArgument(!availableOutputBuffers.contains(outputBuffer));
    outputBuffer.clear();
