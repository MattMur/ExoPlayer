...
public interface VideoRendererEventListener {
  ...
  final class EventDispatcher {
    ...
    public void enabled(DecoderCounters decoderCounters) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onVideoEnabled(decoderCounters));
      }
    }
    ...
    public void inputFormatChanged(
      ...
      if (handler != null) {
        handler.post(
            () -> {
              Util.castNonNull(listener).onVideoInputFormatChanged(format);
              Util.castNonNull(listener).onVideoInputFormatChanged(format, decoderReuseEvaluation);
            });
      }
    }
    ...
    public void droppedFrames(int droppedFrameCount, long elapsedMs) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onDroppedFrames(droppedFrameCount, elapsedMs));
      }
    }
    ...
    public void videoSizeChanged(VideoSize videoSize) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onVideoSizeChanged(videoSize));
      }
    }
    ...
    public void renderedFirstFrame(Object output) {
      if (handler != null) {
        ...
        handler.post(() -> Util.castNonNull(listener).onRenderedFirstFrame(output, renderTimeMs));
      }
    }
    ...
    public void decoderReleased(String decoderName) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onVideoDecoderReleased(decoderName));
      }
    }
    ...
    public void disabled(DecoderCounters counters) {
      ...
      if (handler != null) {
        handler.post(
            () -> {
              counters.ensureUpdated();
              Util.castNonNull(listener).onVideoDisabled(counters);
            });
      }
    }
    ...
    public void videoCodecError(Exception videoCodecError) {
      if (handler != null) {
        handler.post(() -> Util.castNonNull(listener).onVideoCodecError(videoCodecError));
      }
    }
  }
}
