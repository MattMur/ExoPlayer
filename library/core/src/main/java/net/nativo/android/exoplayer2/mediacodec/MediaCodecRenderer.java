...
import static net.nativo.android.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_DRM_SESSION_CHANGED;
import static net.nativo.android.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_OPERATING_RATE_CHANGED;
import static net.nativo.android.exoplayer2.decoder.DecoderReuseEvaluation.DISCARD_REASON_REUSE_NOT_IMPLEMENTED;
...
import static net.nativo.android.exoplayer2.source.SampleStream.FLAG_OMIT_SAMPLE_DATA;
import static net.nativo.android.exoplayer2.source.SampleStream.FLAG_PEEK;
...
import net.nativo.android.exoplayer2.drm.FrameworkCryptoConfig;
...
import net.nativo.android.exoplayer2.source.SampleStream.ReadFlags;
...
import net.nativo.android.exoplayer2.util.TimedValueQueue;
...
public abstract class MediaCodecRenderer extends BaseRenderer {
  ...
  protected abstract @Capabilities int supportsFormat(
      MediaCodecSelector mediaCodecSelector, Format format) throws MediaCodecUtil.DecoderQueryException;
  ...
  protected boolean flushOrReleaseCodec() {
    ...
    if (codecDrainAction == DRAIN_ACTION_FLUSH_AND_UPDATE_DRM_SESSION) {
      Assertions.checkState(Util.SDK_INT >= 23); // Implied by DRAIN_ACTION_FLUSH_AND_UPDATE_DRM_SESSION
