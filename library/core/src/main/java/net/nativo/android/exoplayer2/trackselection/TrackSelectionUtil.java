...
public final class TrackSelectionUtil {
  ...
  public interface AdaptiveTrackSelectionFactory {
     ...
     *
     * @param trackSelectionDefinition A {@link ExoTrackSelection.Definition} for the track selection.
   ...
   *
   * @param definitions The list of track selection {@link ExoTrackSelection.Definition definitions}. May include null
   *     values.
