 ...
 */
package net.nativo.android.exoplayer2.drm;
...
public interface DrmSessionEventListener {
  ...
  /**
   * @deprecated Implement {@link #onDrmSessionAcquired(int, MediaSource.MediaPeriodId, int)} instead.
   */
  @Deprecated
  default void onDrmSessionAcquired(int windowIndex, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {}

  /**
   * Called each time a drm session is acquired.
   *
   * @param windowIndex The window index in the timeline this media period belongs to.
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} associated with the drm session.
   ...
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} associated with the drm session.
   */
  default void onDrmKeysLoaded(int windowIndex, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {}
   ...
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} associated with the drm session.
   */
  default void onDrmKeysRestored(int windowIndex, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {}
   ...
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} associated with the drm session.
   */
  default void onDrmKeysRemoved(int windowIndex, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {}
   ...
   * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} associated with the drm session.
   */
  default void onDrmSessionReleased(int windowIndex, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {}
  ...
  class EventDispatcher {
    ...
    /** The {@link MediaSource.MediaPeriodId} reported with the events. */
     ...
     * @param mediaPeriodId The {@link MediaSource.MediaPeriodId} to be reported with the events.
    ...
    /**
     * Dispatches {@link #onDrmSessionAcquired(int, MediaSource.MediaPeriodId, int)} and {@link
     * #onDrmSessionAcquired(int, MediaSource.MediaPeriodId)}.
     */
    ...
    /** Dispatches {@link #onDrmKeysLoaded(int, MediaSource.MediaPeriodId)}. */
    ...
    /** Dispatches {@link #onDrmSessionManagerError(int, MediaSource.MediaPeriodId, Exception)}. */
    ...
    /** Dispatches {@link #onDrmKeysRestored(int, MediaSource.MediaPeriodId)}. */
    ...
    /** Dispatches {@link #onDrmKeysRemoved(int, MediaSource.MediaPeriodId)}. */
    ...
    /** Dispatches {@link #onDrmSessionReleased(int, MediaSource.MediaPeriodId)}. */
