...
import net.nativo.android.exoplayer2.upstream.cache.CacheKeyFactory;
...
import net.nativo.android.exoplayer2.util.PriorityTaskManager.PriorityTooLowException;
