...
import net.nativo.android.exoplayer2.source.ads.AdsLoader;
import net.nativo.android.exoplayer2.source.ads.AdsMediaSource;
import net.nativo.android.exoplayer2.text.SubtitleDecoderFactory;
import net.nativo.android.exoplayer2.text.SubtitleExtractor;
...
public final class DefaultMediaSourceFactory implements MediaSourceFactory {
  ...
  public DefaultMediaSourceFactory setLocalAdInsertionComponents(
    ...
    this.adsLoaderProvider = Assertions.checkNotNull(adsLoaderProvider);
    this.adViewProvider = Assertions.checkNotNull(adViewProvider);
    return this;
  }
  ...
  public MediaSource createMediaSource(MediaItem mediaItem) {
    ...
    if (scheme != null && scheme.equals(C.SSAI_SCHEME)) {
      return Assertions.checkNotNull(serverSideAdInsertionMediaSourceFactory).createMediaSource(mediaItem);
    }
    @C.ContentType
    int type =
  ...
  private static final class DelegateFactoryLoader {
    ...
    private Supplier<MediaSource.Factory> maybeLoadSupplier(@C.ContentType int contentType) {
      ...
      DataSource.Factory dataSourceFactory = Assertions.checkNotNull(this.dataSourceFactory);
      try {
