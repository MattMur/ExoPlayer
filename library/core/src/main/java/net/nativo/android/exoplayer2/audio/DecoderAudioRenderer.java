...
import net.nativo.android.exoplayer2.decoder.SimpleOutputBuffer;
...
public abstract class DecoderAudioRenderer<
  ...
  public void render(long positionUs, long elapsedRealtimeUs) throws ExoPlaybackException {
    ...
    if (inputFormat == null) {
      ...
      @SampleStream.ReadDataResult int result = readSource(formatHolder, flagsOnlyBuffer, SampleStream.FLAG_REQUIRE_FORMAT);
  ...
  protected DecoderReuseEvaluation canReuseDecoder(
    ...
    return new DecoderReuseEvaluation(
        decoderName, oldFormat, newFormat, DecoderReuseEvaluation.REUSE_RESULT_NO, DecoderReuseEvaluation.DISCARD_REASON_REUSE_NOT_IMPLEMENTED);
  }
    ...
    if (sourceDrmSession != decoderDrmSession) {
      evaluation =
          new DecoderReuseEvaluation(
              ...
              DecoderReuseEvaluation.DISCARD_REASON_DRM_SESSION_CHANGED);
    } else {
      evaluation = canReuseDecoder(decoder.getName(), oldFormat, newFormat);
    }

    if (evaluation.result == DecoderReuseEvaluation.REUSE_RESULT_NO) {
