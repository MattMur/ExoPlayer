...
public final class BundledChunkExtractor implements ExtractorOutput, ChunkExtractor {
  ...
  private static final class BindingTrackOutput implements TrackOutput {
    ...
    public void format(Format format) {
      ...
      Util.castNonNull(trackOutput).format(sampleFormat);
    }
    ...
    public int sampleData(
        ...
        throws IOException {
      return Util.castNonNull(trackOutput).sampleData(input, length, allowEndOfInput);
    }

    @Override
    public void sampleData(ParsableByteArray data, int length, @SampleDataPart int sampleDataPart) {
      Util.castNonNull(trackOutput).sampleData(data, length);
    }
    ...
    public void sampleMetadata(
      ...
      Util.castNonNull(trackOutput).sampleMetadata(timeUs, flags, size, offset, cryptoData);
    }
  }
}
