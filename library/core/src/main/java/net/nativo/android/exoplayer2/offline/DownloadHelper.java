...
import net.nativo.android.exoplayer2.trackselection.BaseTrackSelection;
...
import net.nativo.android.exoplayer2.trackselection.MappingTrackSelector;
 ...
 *       #clearTrackSelections(int)}, {@link #replaceTrackSelections(int, DefaultTrackSelector.Parameters)} and {@link
 *       #addTrackSelection(int, DefaultTrackSelector.Parameters)}.
...
public final class DownloadHelper {
  ...
  public static final DefaultTrackSelector.Parameters DEFAULT_TRACK_SELECTOR_PARAMETERS_WITHOUT_CONTEXT =
      DefaultTrackSelector.Parameters.DEFAULT_WITHOUT_CONTEXT.buildUpon().setForceHighestSupportedBitrate(true).build();
  ...
  /**
   * @deprecated Use {@link #forMediaItem(MediaItem, DefaultTrackSelector.Parameters, RenderersFactory,
   ...
   *
   * @param periodIndex The period index.
   * @return The {@link MappingTrackSelector.MappedTrackInfo} for the period.
   */
  ...
  public void addAudioLanguagesToSelection(String... languages) {
    ...
    for (int periodIndex = 0; periodIndex < mappedTrackInfos.length; periodIndex++) {
      ...
      MappingTrackSelector.MappedTrackInfo mappedTrackInfo = mappedTrackInfos[periodIndex];
   ...
   * @param trackSelectorParameters The {@link DefaultTrackSelector.Parameters} to obtain the new
   *     selection of tracks.
   * @param overrides A list of {@link DefaultTrackSelector.SelectionOverride SelectionOverrides} to apply to the {@code
