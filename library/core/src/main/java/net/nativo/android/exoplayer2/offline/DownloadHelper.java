...
import net.nativo.android.exoplayer2.trackselection.TrackSelectionUtil;
...
public final class DownloadHelper {
  ...
  public static DownloadHelper forMediaItem(Context context, MediaItem mediaItem) {
    Assertions.checkArgument(isProgressive(Assertions.checkNotNull(mediaItem.localConfiguration)));
    return forMediaItem(
        mediaItem,
        getDefaultTrackSelectorParameters(context),
  ...
  public static DownloadHelper forMediaItem(
      ...
      @Nullable DataSource.Factory dataSourceFactory,
      @Nullable DrmSessionManager drmSessionManager) {
    boolean isProgressive = isProgressive(Assertions.checkNotNull(mediaItem.localConfiguration));
    ...
    return new DownloadHelper(
        ...
        isProgressive
            ...
            : createMediaSourceInternal(
                mediaItem, Util.castNonNull(dataSourceFactory), drmSessionManager),
        trackSelectionParameters,
        renderersFactory != null
