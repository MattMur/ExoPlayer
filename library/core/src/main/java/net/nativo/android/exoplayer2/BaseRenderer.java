...
public abstract class BaseRenderer implements Renderer, RendererCapabilities {
  ...
  protected final PlayerId getPlayerId() {
    return Assertions.checkNotNull(playerId);
  }
   ...
   * @return The {@link SampleStream.ReadDataResult result} of the read operation.
   ...
   */
  protected final @SampleStream.ReadDataResult int readSource(
      FormatHolder formatHolder, DecoderInputBuffer buffer, @SampleStream.ReadFlags int readFlags) {
