...
import static net.nativo.android.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_NONE;
import static net.nativo.android.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_PROTECTED_PBUFFER;
import static net.nativo.android.exoplayer2.util.EGLSurfaceTexture.SECURE_MODE_SURFACELESS_CONTEXT;
...
import net.nativo.android.exoplayer2.util.EGLSurfaceTexture.SecureMode;
