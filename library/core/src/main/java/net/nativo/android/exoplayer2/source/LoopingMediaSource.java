...
import net.nativo.android.exoplayer2.AbstractConcatenatedTimeline;
...
public final class LoopingMediaSource extends CompositeMediaSource<Void> {
  ...
  public void releasePeriod(MediaPeriod mediaPeriod) {
    ...
    @Nullable MediaPeriodId childMediaPeriodId = mediaPeriodToChildMediaPeriodId.remove(mediaPeriod);
