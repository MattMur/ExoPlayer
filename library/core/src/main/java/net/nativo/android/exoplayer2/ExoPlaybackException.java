...
import net.nativo.android.exoplayer2.source.MediaPeriodId;
...
public final class ExoPlaybackException extends PlaybackException {
  ...
  /**
   * If {@link #type} is {@link #TYPE_RENDERER}, this is the level of {@link C.FormatSupport} of the
   * renderer for {@link #rendererFormat}. If {@link #rendererFormat} is null, this is {@link
   * C#FORMAT_HANDLED}.
   */
  public final @C.FormatSupport int rendererFormatSupport;
   ...
   * @param rendererFormatSupport The {@link C.FormatSupport} of the renderer for {@code
