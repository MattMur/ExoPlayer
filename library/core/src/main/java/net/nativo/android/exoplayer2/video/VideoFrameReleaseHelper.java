...
public final class VideoFrameReleaseHelper {
  ...
  public void onStarted() {
    ...
    if (displayHelper != null) {
      Assertions.checkNotNull(vsyncSampler).addObserver();
  ...
  public void onStopped() {
    ...
    if (displayHelper != null) {
      ...
      Assertions.checkNotNull(vsyncSampler).removeObserver();
    }
    clearSurfaceFrameRate();
  }
  ...
  private static final class VSyncSampler implements FrameCallback, Handler.Callback {
    ...
    public void doFrame(long vsyncTimeNs) {
      ...
      Assertions.checkNotNull(choreographer).postFrameCallbackDelayed(this, VSYNC_SAMPLE_UPDATE_PERIOD_MS);
    }
