...
import net.nativo.android.exoplayer2.RendererCapabilities.AdaptiveSupport;
...
import net.nativo.android.exoplayer2.util.BundleableUtil;
...
public class DefaultTrackSelector extends MappingTrackSelector {
  ...
  protected final Pair<@NullableType RendererConfiguration[], @NullableType ExoTrackSelection[]>
    ...
    synchronized (lock) {
      ...
      if (parameters.constrainAudioChannelCountToDeviceCapabilities
        ...
        // Looper.myLooper().
        spatializer.ensureInitialized(this, Assertions.checkStateNotNull(Looper.myLooper()));
      }
    }
  ...
  /**
   * Returns true if the {@link C.FormatSupport} in the given {@link Capabilities} is {@link
   ...
   * @param allowExceedsCapabilities Whether to return true if {@link C.FormatSupport} is {@link
   *     C#FORMAT_EXCEEDS_CAPABILITIES}.
   * @return True if {@link C.FormatSupport} is {@link C#FORMAT_HANDLED}, or if {@code
  ...
  protected static boolean isSupported(
    ...
    @C.FormatSupport int maskedSupport = RendererCapabilities.getFormatSupport(formatSupport);
  ...
  private static class SpatializerWrapperV32 {
    ...
    public void release() {
      ...
      Util.castNonNull(handler).removeCallbacksAndMessages(/* token= */ null);
      handler = null;
      listener = null;
    }
  }
