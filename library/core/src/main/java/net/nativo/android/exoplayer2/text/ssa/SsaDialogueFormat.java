 ...
 *
 */
package net.nativo.android.exoplayer2.text.ssa;
...
/* package */ final class SsaDialogueFormat {
  ...
  public static SsaDialogueFormat fromFormatLine(String formatLine) {
    ...
    Assertions.checkArgument(formatLine.startsWith(SsaDecoder.FORMAT_LINE_PREFIX));
    String[] keys = TextUtils.split(formatLine.substring(SsaDecoder.FORMAT_LINE_PREFIX.length()), ",");
