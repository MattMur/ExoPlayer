...
public final class TsExtractor implements Extractor {
   ...
   */
  public TsExtractor(
      @Mode int mode, @DefaultTsPayloadReaderFactory.Flags int defaultTsPayloadReaderFlags, int timestampSearchBytes) {
    this(
        mode,
  ...
  public @ReadResult int read(ExtractorInput input, PositionHolder seekPosition)
    ...
    packetHeaderFlags |= (tsPacketHeader & 0x400000) != 0 ? TsPayloadReader.FLAG_PAYLOAD_UNIT_START_INDICATOR : 0;
