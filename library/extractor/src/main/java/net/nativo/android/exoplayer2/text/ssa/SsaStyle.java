...
/* package */ final class SsaStyle {
  ...
  public static SsaStyle fromStyleLine(String styleLine, Format format) {
    checkArgument(styleLine.startsWith(SsaDecoder.STYLE_LINE_PREFIX));
    String[] styleValues = TextUtils.split(styleLine.substring(SsaDecoder.STYLE_LINE_PREFIX.length()), ",");
