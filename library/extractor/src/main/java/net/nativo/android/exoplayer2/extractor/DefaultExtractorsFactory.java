...
import static net.nativo.android.exoplayer2.util.FileTypes.inferFileTypeFromResponseHeaders;
...
import net.nativo.android.exoplayer2.extractor.amr.AmrExtractor;
import net.nativo.android.exoplayer2.extractor.avi.AviExtractor;
import net.nativo.android.exoplayer2.extractor.flac.FlacExtractor;
import net.nativo.android.exoplayer2.extractor.flv.FlvExtractor;
import net.nativo.android.exoplayer2.extractor.jpeg.JpegExtractor;
import net.nativo.android.exoplayer2.extractor.mkv.MatroskaExtractor;
import net.nativo.android.exoplayer2.extractor.mp3.Mp3Extractor;
...
import net.nativo.android.exoplayer2.extractor.ogg.OggExtractor;
import net.nativo.android.exoplayer2.extractor.ts.Ac3Extractor;
import net.nativo.android.exoplayer2.extractor.ts.Ac4Extractor;
import net.nativo.android.exoplayer2.extractor.ts.AdtsExtractor;
import net.nativo.android.exoplayer2.extractor.ts.DefaultTsPayloadReaderFactory;
import net.nativo.android.exoplayer2.extractor.ts.PsExtractor;
import net.nativo.android.exoplayer2.extractor.ts.TsExtractor;
import net.nativo.android.exoplayer2.extractor.ts.TsPayloadReader;
import net.nativo.android.exoplayer2.extractor.wav.WavExtractor;
