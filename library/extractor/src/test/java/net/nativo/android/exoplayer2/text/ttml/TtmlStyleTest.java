 ...
 */
package net.nativo.android.exoplayer2.text.ttml;

import static android.graphics.Color.BLACK;
import static net.nativo.android.exoplayer2.text.span.TextAnnotation.POSITION_BEFORE;
import static net.nativo.android.exoplayer2.text.ttml.TtmlStyle.STYLE_BOLD;
import static net.nativo.android.exoplayer2.text.ttml.TtmlStyle.STYLE_BOLD_ITALIC;
import static net.nativo.android.exoplayer2.text.ttml.TtmlStyle.STYLE_ITALIC;
import static net.nativo.android.exoplayer2.text.ttml.TtmlStyle.STYLE_NORMAL;
import static net.nativo.android.exoplayer2.text.ttml.TtmlStyle.UNSPECIFIED;
