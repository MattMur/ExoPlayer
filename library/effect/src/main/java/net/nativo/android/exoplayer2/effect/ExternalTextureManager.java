 ...
 */
/* package */ class ExternalTextureManager implements GlTextureProcessor.InputListener {
   ...
   *     ExternalTextureManager} will be set as the {@link GlTextureProcessor.InputListener}.
